...
const MessageContainer = ({ projectId,activeFragment,setActiveFragment }: Props) => {
  ...
  const { data: messages } = useSuspenseQuery(
    trpc.messages.getMany.queryOptions({ projectId: projectId },{refetchInterval : 2000})
  );
  ...
  return (
    <div className="flex flex-col flex-1 min-h-0">
      ...
      <div className="relative p-3 pt-1">
        <div className="absolute -top-6 left-0 right-0 h-6 bg-gradient-to-b from-transparent to to-background/70 pointer-events-none" />
